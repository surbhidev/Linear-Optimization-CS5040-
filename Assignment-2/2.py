...
def check_bounded(A, v):
    c = np.zeros(A.shape[1])

    res = linprog(c, A_ub=A, b_ub=v, method='highs')
...
if __name__ == "__main__":
    ...
    if check_bounded(A, v):
        print("The polytope is bounded.")
    else:
        print("The polytope is unbounded.")
